...
char* operation_to_string(const struct df_operation operation) {
    char* category_string;
    char* operation_string;
    switch (operation.category) {
        case DF_CAST:
            category_string = "CAST";
            switch ((enum df_cast_ops)operation.operation) {
        ...
        case DF_LOGIC:
            ...
            switch ((enum df_logic_ops)operation.operation) {
                case DF_LOGIC_NOT:
        ...
        case DF_ARITHMETIC:
            ...
            switch ((enum df_arithmetic_ops)operation.operation) {
        ...
        case DF_INTERNAL:
            ...
            switch ((enum df_internal_ops)operation.operation) {
        ...
        case DF_MACHINE_LEARNING:
            ...
            switch ((enum df_machine_learning_ops)operation.operation) {
