...
TEST_CASE("arithmetic: divide: no value") {
    const enum df_arithmetic_ops arithmetic_operation = DF_ARITH_DIVISION;
...
TEST_CASE("arithmetic: divide: two values") {
    ...
    SECTION("TS_DOUBLE") {
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_DOUBLE);
        REQUIRE(result->value.ts_double == 4.0 / 4);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DATETIME") {
        const struct ts_value op1 = {.type = TS_TIMESTAMP, .value = {.ts_long = 4}};
...
TEST_CASE("arithmetic: divide: five values") {
    ...
    SECTION("TS_BYTE") {
        const struct ts_value op1 = {.type = TS_BYTE, .value = {.ts_int = 32}};
        const struct ts_value op2 = {.type = TS_BYTE, .value = {.ts_int = 2}};
        const struct ts_value op3 = {.type = TS_BYTE, .value = {.ts_int = 2}};
        const struct ts_value op4 = {.type = TS_BYTE, .value = {.ts_int = 2}};
        const struct ts_value op5 = {.type = TS_BYTE, .value = {.ts_int = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_BYTE, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BYTE);
        REQUIRE(result->value.ts_int == 32 / 2 / 2 / 2 / 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_SHORT") {
        const struct ts_value op1 = {.type = TS_SHORT, .value = {.ts_int = 32}};
        const struct ts_value op2 = {.type = TS_SHORT, .value = {.ts_int = 2}};
        const struct ts_value op3 = {.type = TS_SHORT, .value = {.ts_int = 2}};
        const struct ts_value op4 = {.type = TS_SHORT, .value = {.ts_int = 2}};
        const struct ts_value op5 = {.type = TS_SHORT, .value = {.ts_int = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_SHORT, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("TS_INTEGER") {
        const struct ts_value op1 = {.type = TS_INTEGER, .value = {.ts_int = 32}};
        const struct ts_value op2 = {.type = TS_INTEGER, .value = {.ts_int = 2}};
        const struct ts_value op3 = {.type = TS_INTEGER, .value = {.ts_int = 2}};
        const struct ts_value op4 = {.type = TS_INTEGER, .value = {.ts_int = 2}};
        const struct ts_value op5 = {.type = TS_INTEGER, .value = {.ts_int = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_INTEGER, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("TS_LONG") {
        const struct ts_value op1 = {.type = TS_LONG, .value = {.ts_long = 32}};
        const struct ts_value op2 = {.type = TS_LONG, .value = {.ts_long = 2}};
        const struct ts_value op3 = {.type = TS_LONG, .value = {.ts_long = 2}};
        const struct ts_value op4 = {.type = TS_LONG, .value = {.ts_long = 2}};
        const struct ts_value op5 = {.type = TS_LONG, .value = {.ts_long = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_LONG, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_LONG);
        REQUIRE(result->value.ts_long == 32 / 2 / 2 / 2 / 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_BYTE") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 32}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op3 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_UNSIGNED_BYTE, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_UNSIGNED_BYTE);
        REQUIRE(result->value.ts_unsigned_int == 32 / 2 / 2 / 2 / 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_SHORT") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 32}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op3 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_UNSIGNED_SHORT, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("TS_UNSIGNED_INTEGER") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 32}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op3 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_arithmetic_operation_with_type(
            arithmetic_operation, op_list, operand_count, TS_UNSIGNED_INTEGER, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("TS_UNSIGNED_LONG") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 32}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 2}};
        const struct ts_value op3 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 2}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 2}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_UNSIGNED_LONG, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_UNSIGNED_LONG);
        REQUIRE(result->value.ts_unsigned_long == 32 / 2 / 2 / 2 / 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DOUBLE") {
        const struct ts_value op1 = {.type = TS_DOUBLE, .value = {.ts_double = 32}};
        const struct ts_value op2 = {.type = TS_DOUBLE, .value = {.ts_double = 2}};
        const struct ts_value op3 = {.type = TS_DOUBLE, .value = {.ts_double = 2}};
        const struct ts_value op4 = {.type = TS_DOUBLE, .value = {.ts_double = 2}};
        const struct ts_value op5 = {.type = TS_DOUBLE, .value = {.ts_double = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_DOUBLE, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_DOUBLE);
        REQUIRE(result->value.ts_double == 32.0 / 2 / 2 / 2 / 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DATETIME") {
        const struct ts_value op1 = {.type = TS_TIMESTAMP, .value = {.ts_long = 32}};
        const struct ts_value op2 = {.type = TS_TIMESTAMP, .value = {.ts_long = 2}};
        const struct ts_value op3 = {.type = TS_TIMESTAMP, .value = {.ts_long = 2}};
        const struct ts_value op4 = {.type = TS_TIMESTAMP, .value = {.ts_long = 2}};
        const struct ts_value op5 = {.type = TS_TIMESTAMP, .value = {.ts_long = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_arithmetic_operation_with_type(arithmetic_operation, op_list, operand_count, TS_TIMESTAMP, &result);
        REQUIRE(&result != NULL);
