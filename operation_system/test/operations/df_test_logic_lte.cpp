...
TEST_CASE("logic: lte: no value") {
    const enum df_logic_ops logic_operation = DF_LOGIC_LESS_THAN_EQUALS;
...
TEST_CASE("logic: lte: five values") {
    ...
    SECTION("TS_BYTE") {
        ...
        const struct ts_value op3 = {.type = TS_BYTE, .value = {.ts_int = 3}};
        const struct ts_value op4 = {.type = TS_BYTE, .value = {.ts_int = 3}};
        const struct ts_value op5 = {.type = TS_BYTE, .value = {.ts_int = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_BYTE, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_SHORT") {
        ...
        const struct ts_value op3 = {.type = TS_SHORT, .value = {.ts_int = 3}};
        const struct ts_value op4 = {.type = TS_SHORT, .value = {.ts_int = 3}};
        const struct ts_value op5 = {.type = TS_SHORT, .value = {.ts_int = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_SHORT, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_INTEGER") {
        ...
        const struct ts_value op4 = {.type = TS_INTEGER, .value = {.ts_int = 3}};
        const struct ts_value op5 = {.type = TS_INTEGER, .value = {.ts_int = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_INTEGER, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_LONG") {
        ...
        const struct ts_value op3 = {.type = TS_LONG, .value = {.ts_long = 3}};
        const struct ts_value op4 = {.type = TS_LONG, .value = {.ts_long = 3}};
        const struct ts_value op5 = {.type = TS_LONG, .value = {.ts_long = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_LONG, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_UNSIGNED_BYTE") {
        ...
        const struct ts_value op3 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 3}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 3}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_UNSIGNED_BYTE, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_UNSIGNED_SHORT") {
        ...
        const struct ts_value op3 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 3}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 3}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_UNSIGNED_SHORT, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("TS_UNSIGNED_INTEGER") {
        ...
        const struct ts_value op3 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 3}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 3}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value =
            df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_UNSIGNED_INTEGER, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("TS_UNSIGNED_LONG") {
        ...
        const struct ts_value op3 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 3}};
        const struct ts_value op4 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 3}};
        const struct ts_value op5 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_UNSIGNED_LONG, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_DOUBLE") {
        ...
        const struct ts_value op3 = {.type = TS_DOUBLE, .value = {.ts_double = 3}};
        const struct ts_value op4 = {.type = TS_DOUBLE, .value = {.ts_double = 3}};
        const struct ts_value op5 = {.type = TS_DOUBLE, .value = {.ts_double = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_DOUBLE, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
    ...
    SECTION("TS_DATETIME") {
        ...
        const struct ts_value op3 = {.type = TS_TIMESTAMP, .value = {.ts_long = 3}};
        const struct ts_value op4 = {.type = TS_TIMESTAMP, .value = {.ts_long = 3}};
        const struct ts_value op5 = {.type = TS_TIMESTAMP, .value = {.ts_long = 5}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_TIMESTAMP, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
...
TEST_CASE("logic: lte: five different value types") {
    ...
    SECTION("DIFFERENT->0") {
        ...
        const struct ts_value op5 = {.type = TS_DOUBLE, .value = {.ts_double = 3}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_BOOLEAN, &result);
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BOOLEAN);
