...
TEST_CASE("arithmetic: modulo: no value") {
    const enum df_arithmetic_ops arithmetic_operation = DF_ARITH_MODULO;
...
TEST_CASE("arithmetic: modulo: five values") {
    ...
    SECTION("TS_LONG") {
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_LONG);
        REQUIRE(result->value.ts_long == 0);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_BYTE") {
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_UNSIGNED_BYTE);
        REQUIRE(result->value.ts_unsigned_int == 0);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_SHORT") {
    ...
    SECTION("TS_UNSIGNED_LONG") {
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_UNSIGNED_LONG);
        REQUIRE(result->value.ts_unsigned_long == 0);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DOUBLE") {
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_DOUBLE);
        REQUIRE(result->value.ts_double == 0);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DATETIME") {
