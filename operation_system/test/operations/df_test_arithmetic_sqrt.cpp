...
TEST_CASE("arithmetic: sqrt: no value") {
    const enum df_arithmetic_ops arithmetic_operation = DF_ARITH_SQRT;
...
TEST_CASE("arithmetic: sqrt: one value") {
    ...
    SECTION("TS_LONG") {
        ...
        REQUIRE(result->value.ts_long == 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_BYTE") {
        ...
        REQUIRE(result->value.ts_unsigned_int == 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_SHORT") {
    ...
    SECTION("TS_UNSIGNED_LONG") {
        ...
        REQUIRE(result->value.ts_unsigned_long == 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DOUBLE") {
        ...
        REQUIRE(result->value.ts_double == 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DATETIME") {
