...
TEST_CASE("arithmetic: multiply: no value") {
    const enum df_arithmetic_ops arithmetic_operation = DF_ARITH_MULTIPLICATION;
...
TEST_CASE("arithmetic: multiply: five values") {
    ...
    SECTION("TS_BYTE") {
        const struct ts_value op1 = {.type = TS_BYTE, .value = {.ts_int = 2}};
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_BYTE);
        REQUIRE(result->value.ts_int == 2 * 2 * 2 * 2 * 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_SHORT") {
        const struct ts_value op1 = {.type = TS_SHORT, .value = {.ts_int = 2}};
    ...
    SECTION("TS_INTEGER") {
        const struct ts_value op1 = {.type = TS_INTEGER, .value = {.ts_int = 2}};
    ...
    SECTION("TS_LONG") {
        const struct ts_value op1 = {.type = TS_LONG, .value = {.ts_long = 2}};
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_LONG);
        REQUIRE(result->value.ts_long == 2 * 2 * 2 * 2 * 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_BYTE") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 2}};
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_UNSIGNED_BYTE);
        REQUIRE(result->value.ts_unsigned_int == 2 * 2 * 2 * 2 * 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_UNSIGNED_SHORT") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 2}};
    ...
    SECTION("TS_UNSIGNED_INTEGER") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 2}};
    ...
    SECTION("TS_UNSIGNED_LONG") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 2}};
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_UNSIGNED_LONG);
        REQUIRE(result->value.ts_unsigned_long == 2 * 2 * 2 * 2 * 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DOUBLE") {
        const struct ts_value op1 = {.type = TS_DOUBLE, .value = {.ts_double = 2}};
        ...
        REQUIRE(&result != NULL);
        REQUIRE(result->type == TS_DOUBLE);
        REQUIRE(result->value.ts_double == 2 * 2 * 2 * 2 * 2);
        REQUIRE(return_value == 1);
    } //
    SECTION("TS_DATETIME") {
        const struct ts_value op1 = {.type = TS_TIMESTAMP, .value = {.ts_long = 2}};
