...
TEST_CASE("logic: gte: no value") {
    const enum df_logic_ops logic_operation = DF_LOGIC_GREATER_THAN_EQUALS;
...
TEST_CASE("logic: gte: five values") {
    ...
    SECTION("TS_BYTE") {
        const struct ts_value op1 = {.type = TS_BYTE, .value = {.ts_int = 5}};
        const struct ts_value op2 = {.type = TS_BYTE, .value = {.ts_int = 3}};
    ...
    SECTION("TS_SHORT") {
        const struct ts_value op1 = {.type = TS_SHORT, .value = {.ts_int = 5}};
        const struct ts_value op2 = {.type = TS_SHORT, .value = {.ts_int = 3}};
    ...
    SECTION("TS_INTEGER") {
        const struct ts_value op1 = {.type = TS_INTEGER, .value = {.ts_int = 5}};
        const struct ts_value op2 = {.type = TS_INTEGER, .value = {.ts_int = 3}};
    ...
    SECTION("TS_LONG") {
        const struct ts_value op1 = {.type = TS_LONG, .value = {.ts_long = 5}};
        const struct ts_value op2 = {.type = TS_LONG, .value = {.ts_long = 3}};
    ...
    SECTION("TS_UNSIGNED_BYTE") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 5}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 3}};
    ...
    SECTION("TS_UNSIGNED_SHORT") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 5}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_SHORT, .value = {.ts_unsigned_int = 3}};
    ...
    SECTION("TS_UNSIGNED_INTEGER") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 5}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_INTEGER, .value = {.ts_unsigned_int = 3}};
    ...
    SECTION("TS_UNSIGNED_LONG") {
        const struct ts_value op1 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 5}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_LONG, .value = {.ts_unsigned_long = 3}};
    ...
    SECTION("TS_DOUBLE") {
        const struct ts_value op1 = {.type = TS_DOUBLE, .value = {.ts_double = 5}};
        const struct ts_value op2 = {.type = TS_DOUBLE, .value = {.ts_double = 3}};
    ...
    SECTION("TS_DATETIME") {
        const struct ts_value op1 = {.type = TS_TIMESTAMP, .value = {.ts_long = 5}};
        const struct ts_value op2 = {.type = TS_TIMESTAMP, .value = {.ts_long = 3}};
...
TEST_CASE("logic: gte: five different value types") {
    ...
    int return_value;
    SECTION("DIFFERENT->0") {
        const struct ts_value op1 = {.type = TS_BYTE, .value = {.ts_int = 3}};
