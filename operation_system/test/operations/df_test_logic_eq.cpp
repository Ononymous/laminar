...
TEST_CASE("logic: eq: no value") {
    const enum df_logic_ops logic_operation = DF_LOGIC_EQUALS;
...
TEST_CASE("logic: eq: five values") {
    ...
    SECTION("TS_BOOLEAN") {
        ...
        const struct ts_value op3 = {.type = TS_BOOLEAN, .value = {.ts_int = 1}};
...
TEST_CASE("logic: eq: five different value types") {
    ...
    SECTION("DIFFERENT->0") {
        const struct ts_value op1 = {.type = TS_BYTE, .value = {.ts_int = 2}};
        const struct ts_value op2 = {.type = TS_UNSIGNED_BYTE, .value = {.ts_unsigned_int = 2}};
        const struct ts_value op3 = {.type = TS_INTEGER, .value = {.ts_int = 3}};
        const struct ts_value op4 = {.type = TS_LONG, .value = {.ts_long = 2}};
        const struct ts_value op5 = {.type = TS_DOUBLE, .value = {.ts_double = 2}};
        const struct ts_value* op_list[5] = {&op1, &op2, &op3, &op4, &op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, TS_BOOLEAN, &result);
