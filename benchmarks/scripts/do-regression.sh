...
rm -f regression_mapreduce.txt
touch regression_mapreduce.txt
rm -f namespace.log
...
for num in "${mappers[@]}"; do
    ...
    sleep 5 &&
    ./logistic_regression_mapreduce -m $num >> regression_mapreduce.txt
    rm -rf tmp_data
    sleep 1
done
...
echo "Linear Scaling"
echo "------------------------"
grep "AVERAGE" regression_mapreduce.txt
echo "========================"
rm -rf lmr*
...
for num in "${mappers[@]}"; do
    ...
    ./woofc-namespace-platform >& namespace.log &
    sleep 5 &&
    ./logistic_regression_mapreduce -m $num -p $pts_per_mapper >> regression_mapreduce.txt
    rm -rf tmp_data
    sleep 1
done
